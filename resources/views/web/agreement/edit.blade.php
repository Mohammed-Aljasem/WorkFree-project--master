        ...
        <form action="{{ route('agreements.update', $agreement->id) }}" method="post">
            ...
            <div class="sections__title">
                ...
                <div class="agreement__inputs">
                    ...
                    <input type="text" name="project_title" value="{{ $agreement->project_title }}" required>
                    <input type="text" name="freelance_id" style="display: none" value="{{ $agreement->freelance_id }}">
                </div>
            </div>
            <div class="sections__title">
                ...
                <div class="agreement__inputs">
                    ...
                    <textarea name="description" id="" cols="30" rows="10"
                        required> {{ $agreement->description }}</textarea>
                </div>
            </div>
                            ...
                            @foreach ($agreement->requirement as $require)
                                <div id="require" class="require">
                                    ...
                                    <div class="agreement__inputs">
                                        ...
                                        <input type="text" name="requirement_title[]" value="{{ $require->title }}"
                                            required>
                                    </div>
                                    <div class="agreement__inputs">
                                        <label for="title">Input Title</label>
                                        <textarea name="require_description[]" id="" cols="30" rows="10"
                                            required> {{ $require->description }}</textarea>
                                    </div>
                                    <br>
                                    <hr>
                                    <br>
            ...
            <div class="sections__title">
                ...
                <div class="agreement__inputs__group agreement__detail">
                    <div class="agreement__inputs">
                        ...
                        <input type="text" name="budget" value="{{ $agreement->budget }}" required>
                    </div>
                    <div class="agreement__inputs">
                        <label for="date_start">Data Start</label>
                        <input type="date" name="date_start" required value="{{ $agreement->date_start }}">
                    </div>
                    <div class="agreement__inputs">
                        <label for="date_end">Data end</label>
                        <input type="date" name="date_end" required value="{{ $agreement->date_end }}">
                    </div>
                </div>
            </div>
            <div class="agreement__inputs__group ">
                <div class="agreement__inputs">
                    ...
                    <input type="date" name="buffer_time" required value="{{ $agreement->buffer_time }}">
                </div>
                <div class=" agreement__inputs">
                    <div class="flex__end">
