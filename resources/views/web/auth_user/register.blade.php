...
<head>
    ...
    <!-- Main Style Css -->
    <link rel="stylesheet" href="{{ asset('login-register/css/register.css') }}" />
</head>
    ...
    <div class="page-content">
        <div class="form-v4-content">
            <div class="form-left">
                ...
                <p class="text-1">We are sure that you will achieve many things by joining the WorkFree family.</p>
                <p class="text-2">Also, we are sure that you will achieve many things during your journey with us.
                </p>
            ...
            <form class="form-detail" action="{{ url('register') }}" method="post" id="myform"
                ...
                <div class="form-row">
                    <label class="container-agree">
                        <p>If you have account go to <a href="{{ url('/login') }}" class="text">login</a></p>
                ...
                <div class="form-row-last">
                    <input type="submit" name="register" class="primary__btn" value="Register" id="register">
                </div>
            </form>
        </div>
    </div>
