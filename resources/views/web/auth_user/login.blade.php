...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('login-register/fonts/line-awesome/css/line-awesome.min.css') }}">
    <!-- Jquery -->
...
<body class="form-v4">
    <div class="page-content">
        <div class="form-v4-content">
            <div class="form-left">
                <h2>Work<span>Free</span></h2>
                <p class="text-1">Very happy to come back again.</p>
                <p class="text-2">We are excited to see you new achievements because we have developed from your
            ...
            <form class="form-detail" action="#" method="post" action="{{ url('/login') }}" id="myform"
                ...
                <div class="form-row">
                    <p>You can <a href="{{ url('/register') }}" class="text">register</a> or <a
                            href="{{ url('/forgot-password') }}" class="text">reset password</a>
                    </p>
                ...
                <div class="form-row-last">
                    <input type="submit" name="register" class="primary__btn" value="Login">
                </div>
                ...
                <div class="form-row-last btns-social">
                    <a class="social-btn" href="{{ url('/login/google') }}"
                        style="display: flex; justify-content: center; align-items: center;">
                        <span>
                            <img src="{{ asset('login-register/images/google.svg') }}"
                    ...
                    <a class="social-btn" href="{{ url('/login/facebook') }}">
                        <span>
                            <img src="{{ asset('login-register/images/facebook.svg') }}"
                                style="width: 2rem; height: 2rem">
                        </span>
                        <span class="title-btn">
                            Facebook
